...
> 自动更新 | 总论文数: 87 | 最后更新: 2026-04-16 04:32 UTC
  ...
  root((材料模拟论文体系))
    ...
    Metal Fatigue Simulation [4篇]
      ...
      Magnetic Tactile-Driven Soft...
        ...
        fatigue
        deformation
    Tensile / Deformation Simulation [23篇]
      Fully Coupled Multiphysics Mo...
        fatigue
        multiphysics
        crack
...
| 主题方向 | 论文数 | 主要侧重点 | 代表论文 |
|----------|--------|------------|----------|
| Multiphysics Coupling | 26 | 多物理耦合与跨场耦合机制, 分子动力学与原子尺度机制, 拉伸响应与本构行为 | Fully Coupled Multiphysics Model... |
| Molecular Dynamics | 61 | 分子动力学与原子尺度机制, 多物理耦合与跨场耦合机制, 数据驱动与机器学习建模 | Electrohydrodynamic instability... |
...
| Tensile / Deformation Simulation | 23 | 拉伸响应与本构行为, 分子动力学与原子尺度机制, 疲劳损伤与断裂演化 | Fully Coupled Multiphysics Model... |
